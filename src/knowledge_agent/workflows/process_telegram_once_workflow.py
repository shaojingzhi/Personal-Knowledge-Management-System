...
from knowledge_agent.collectors.telegram_ingestor import TelegramIngestor
from knowledge_agent.config import Settings
from knowledge_agent.dispatch.telegram_dispatcher import TelegramDispatcher
from knowledge_agent.storage.answer_artifact_store import AnswerArtifactStore
...
from knowledge_agent.workflows.schemas import SourceBundle
...
class ProcessTelegramOnceWorkflow:
    ...
    def _run_cli_stage(
        ...
        *,
        ...
        command = [sys.executable, "-m", "knowledge_agent.main", *args]
        try:
    ...
    def _backfill_full_answers_node(self, state: BundleProcessState) -> dict[str, object]:
        ...
        command = [
            ...
            (
                ...
                "cmd = [sys.executable, '-m', 'knowledge_agent.main', "
