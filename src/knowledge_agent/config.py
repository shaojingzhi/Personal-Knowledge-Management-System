...
def _resolve_profile_dir() -> str:
    configured_value = os.getenv("XHS_PROFILE_DIR")
    if configured_value is not None:
        return configured_value
    preferred_path = Path("./data/knowledge-agent-profile")
    legacy_path = Path("./data/xhs-profile")
...
def load_settings() -> Settings:
    return Settings(
        ...
        xhs_profile_dir=_resolve_profile_dir(),
