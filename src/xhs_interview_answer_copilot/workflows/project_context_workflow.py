...
class ProjectContextWorkflow:
    ...
    def _collect_key_files(self, root: Path) -> list[str]:
        explicit_candidates = [
            ...
            "pyproject.toml",
            "package.json",
            "src/xhs_interview_answer_copilot/main.py",
            "src/xhs_interview_answer_copilot/config.py",
            "src/xhs_interview_answer_copilot/workflows/process_telegram_once_workflow.py",
            "src/xhs_interview_answer_copilot/workflows/process_telegram_daemon_workflow.py",
            "src/xhs_interview_answer_copilot/workflows/generate_answers_workflow.py",
            "src/xhs_interview_answer_copilot/workflows/normalize_note_workflow.py",
            "src/xhs_interview_answer_copilot/workflows/retrieve_questions.py",
            "src/xhs_interview_answer_copilot/storage/telegram_state_store.py",
            "src/xhs_interview_answer_copilot/storage/vector_store.py",
            "src/xhs_interview_answer_copilot/storage/answer_artifact_store.py",
            "src/xhs_interview_answer_copilot/dispatch/telegram_dispatcher.py",
        ]
        selected: list[str] = []
        seen: set[str] = set()
